...
import com.hnm.hnm.repository.member.RefreshTokenRepository;
...
public class AuthService {
    ...
    public MemberResponseDto signUp(MemberRequestDto memberRequestDto) {
        ...
        // 소셜로그인 말고 이메일로 가입한 경우
        if (memberRequestDto.getOauth().equals("N")) {
            EmailToken emailToken = EmailToken.builder()
                    .key(memberRequestDto.getEmail())
                    .value(tokenProvider.generateEmailToken(memberRequestDto.getEmail()))
                    .build();
